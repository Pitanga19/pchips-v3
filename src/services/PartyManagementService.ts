// pchips-v3/src/services/PartyManagementService.ts

import { EResponseStatus, EResponseMessage } from "../utils/enums/statusEnums";
import { TErrorList } from "../utils/types/errorTypes";
import PartyService from "./PartyService";
import PartyUserService from "./PartyUserService";
import {
    validatePartyName, checkPermissions,validateDifferentUsers, validateExistingParty,
    validateIsOwnerOrAdmin, validateIsOwner, validateExistingPartyUser,
    validateExistingUser,
} from "../utils/partyUtils";
import {
    TPartyReturn, TUserReturn, TPartyUserReturn, TPartyUserUpdates,
    TPartyList, TUserList, TPartyManagementReturn, TPartyUserDeleteManagementReturn,
    TUserPartyListReturn, TPartyUserListReturn,

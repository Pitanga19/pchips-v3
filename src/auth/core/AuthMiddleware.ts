...
import { EAuthProcess, validateUsername, validateEmail, validatePassword, validateExistingInputs, validatEUserFind, validateRepeatPassword, validateExistingUpdates, TRegisterBody, TLoginBody, TRecoverBody, TUpdateBody } from '../authIndex';

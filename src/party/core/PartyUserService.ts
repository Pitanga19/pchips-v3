...
import { TPartyUserListConditions, TPartyUserDeleteReturn, TPartyUserModelListReturn, TPartyUserModelReturn, TPartyUserServiceReturn, TPartyUserUpdates, TUserPartyModelListReturn, TUserPartyListConditions } from '../partyIndex';
